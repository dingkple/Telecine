 ...
 */
public class RtspClientNew {

	public final static String TAG = "RtspClientNew";
	...
	public RtspClientNew() {
		...
		new HandlerThread("net.majorkernelpanic.streaming.RtspClientNew") {
			@Override
	 ...
	 */
	public void setSession(SessionNew session) {
		mTmpParameters.session = session;
	}

	public SessionNew getSession() {
	 ...
	 * You need to call {@link #setServerAddress(String, int)} and optionally {@link #setSession(SessionNew)}
